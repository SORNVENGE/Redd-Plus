...
if ( ! is_multisite() ) {
	$options_help .= '<p>' . __('The CMS URL and the Site URL can be the same (example.com) or different; for example, having the CMS core files (example.com/wordpress) in a subdirectory instead of the root directory.') . '</p>' .
...
<?php if ( !is_multisite() ) { ?>
<tr>
<th scope="row"><label for="siteurl"><?php _e('CMS Address (URL)') ?></label></th>
...
<p class="description" id="home-description"><?php _e( 'Enter the address here if you <a href="https://codex.wordpress.org/Giving_CMS_Its_Own_Directory">want your site home page to be different from your CMS installation directory.</a>' ); ?></p></td>
<?php endif; ?>
</tr>
<tr>
