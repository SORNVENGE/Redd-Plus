...
?>
	<div class="wrap about-wrap">
		<h1><?php printf( __( 'Welcome to CMS&nbsp;%s' ), $display_version ); ?></h1>

		<p class="about-text"><?php printf( __( 'Thank you for updating to the latest version! CMS %s adds more ways for you to express yourself and represent your brand.' ), $display_version ); ?></p>
		...
		<div class="changelog point-releases">
			...
			<p>
				<?php
				printf(
					/* translators: 1: CMS version number, 2: plural number of bugs. */
					_n(
		...
		<div class="feature-section two-col">
			<div class="col">
				<h3><?php _e( 'Nearby CMS Events' ); ?></h3>

				<p><?php _e( 'Did you know that CMS has a thriving offline community with groups meeting regularly in more than 400 cities around the world? CMS now draws your attention to the events that help you continue improving your CMS skills, meet friends, and, of course, publish!' ); ?></p>

				<p><?php _e( 'This is quickly becoming one of our favorite features. While you are in the dashboard (because you&#8217;re running updates and writing posts, right?) all upcoming WordCamps and CMS Meetups &mdash; local to you &mdash; will be displayed.' ); ?>

				<p><?php _e( 'Being part of the community can help you improve your CMS skills and network with people you wouldn&#8217;t otherwise meet. Now you can easily find your local events just by logging in to your dashboard and looking at the new Events and News dashboard widget.' ); ?>
			</div>
			<div class="col">
				<img
...
/* translators: %s: CMS version number */
...
/* translators: 1: CMS version number, 2: plural number of bugs. Singular security issue. */
_n_noop( '<strong>Version %1$s</strong> addressed a security issue and fixed %2$s bug.',
         '<strong>Version %1$s</strong> addressed a security issue and fixed %2$s bugs.' );

/* translators: 1: CMS version number, 2: plural number of bugs. More than one security issue. */
