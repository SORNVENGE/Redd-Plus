<?php
/**
 * CMS Dashboard Widget Administration Screen API
 *
 * @package CMS
...
function wp_dashboard_setup() {
	...
	// CMS Events and News
	wp_add_dashboard_widget( 'dashboard_primary', __( 'CMS Events and News' ), 'wp_dashboard_events_news' );
...
function wp_dashboard_primary() {
	$feeds = array(
		'news' => array(
			...
			/**
			 * Filters the primary link URL for the 'CMS News' dashboard widget.
			 *
			 * @since 2.5.0
			 *
			...
			/**
			 * Filters the primary feed URL for the 'CMS News' dashboard widget.
			 *
			 * @since 2.3.0
			 *
			...
			/**
			 * Filters the primary link title for the 'CMS News' dashboard widget.
			 *
			 * @since 2.3.0
			 *
			 * @param string $title Title attribute for the widget's primary link.
			 */
			'title'        => apply_filters( 'dashboard_primary_title', __( 'CMS Blog' ) ),
			'items'        => 1,
			'show_summary' => 0,
			'show_author'  => 0,
			'show_date'    => 0,
		...
		'planet' => array(
			...
			/**
			 * Filters the secondary link URL for the 'CMS News' dashboard widget.
			 *
			 * @since 2.3.0
			 *
			...
			/**
			 * Filters the secondary feed URL for the 'CMS News' dashboard widget.
			 *
			 * @since 2.3.0
			 *
			...
			/**
			 * Filters the secondary link title for the 'CMS News' dashboard widget.
			 *
			 * @since 2.3.0
			 *
			 * @param string $title Title attribute for the widget's secondary link.
			 */
			'title'        => apply_filters( 'dashboard_secondary_title', __( 'Other CMS News' ) ),

			/**
			 * Filters the number of secondary link items for the 'CMS News' dashboard widget.
			 *
			 * @since 4.4.0
			 *
...
function wp_dashboard_browser_nag() {
	...
	if ( $response ) {
		if ( $response['insecure'] ) {
			...
			$msg = sprintf( __( "It looks like you're using an insecure version of %s. Using an outdated browser makes your computer unsafe. For the best CMS experience, please update your browser." ),
				sprintf( '<a href="%s">%s</a>', esc_url( $response['update_url'] ), esc_html( $response['name'] ) )
			);
		} else {
			/* translators: %s: browser name and link */
			$msg = sprintf( __( "It looks like you're using an old version of %s. For the best CMS experience, please update your browser." ),
				sprintf( '<a href="%s">%s</a>', esc_url( $response['update_url'] ), esc_html( $response['name'] ) )
			);
		}
...
function wp_check_browser_version() {
	...
	if ( false === ($response = get_site_transient('browser_' . $key) ) ) {
		$options = array(
			...
			'user-agent'	=> 'CMS/' . get_bloginfo( 'version' ) . '; ' . home_url()
		);
...
/**
 * Displays a welcome panel to introduce users to CMS.
 *
 * @since 3.3.0
 */
function wp_welcome_panel() {
	...
	<div class="welcome-panel-column welcome-panel-last">
		...
		<?php endif; ?>
			<li><?php printf( '<a href="%s" class="welcome-icon welcome-learn-more">' . __( 'Learn more about getting started' ) . '</a>', __( 'https://codex.wordpress.org/First_Steps_With_CMS' ) ); ?></li>
		</ul>
	</div>
	</div>
	</div>
