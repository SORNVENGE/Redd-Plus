...
function delete_theme($stylesheet, $redirect = '') {
	...
	if ( empty( $themes_dir ) ) {
		return new WP_Error( 'fs_no_themes_dir', __( 'Unable to locate CMS theme directory.' ) );
	}
...
/**
 * Retrieve list of CMS theme features (aka theme tags)
 *
 * @since 3.1.0
 *
 * @param bool $api Optional. Whether try to fetch tags from the CMS.org API. Defaults to true.
...
/**
 * Retrieves theme installer pages from the CMS.org Themes API.
 *
 ...
 *
 * The second filter, {@see 'themes_api'}, allows a plugin to override the CMS.org
...
function themes_api( $action, $args = array() ) {
	...
	/**
	 * Filters arguments used to query for installer pages from the CMS.org Themes API.
	 *
	 * Important: An object MUST be returned to this filter.
	 *
	 * @since 2.8.0
	 *
	 * @param object $args   Arguments used to query for installer pages from the CMS.org Themes API.
	...
	/**
	 * Filters whether to override the CMS.org Themes API.
	 *
	 ...
	 * @since 2.8.0
	 *
	 * @param false|object|array $override Whether to override the CMS.org Themes API. Default false.
	 * @param string             $action   Requested action. Likely values are 'theme_information',
	 *                                    'feature_list', or 'query_themes'.
	...
	/**
	 * Filters the returned CMS.org Themes API response.
	 *
	 * @since 2.8.0
	 *
	 * @param array|object|WP_Error $res    CMS.org Themes API response.
	 * @param string                $action Requested action. Likely values are 'theme_information',
	 *                                      'feature_list', or 'query_themes'.
	 * @param object                $args   Arguments used to query for installer pages from the CMS.org Themes API.
	 */
