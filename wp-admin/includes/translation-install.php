<?php
/**
 * CMS Translation Install Administration API
 *
 * @package CMS
...
/**
 * Retrieve translations from CMS Translation API.
 *
 * @since 4.0.0
 *
...
function translations_api( $type, $args = null ) {
	...
	/**
	 * Allows a plugin to override the CMS.org Translation Install API entirely.
	 *
	 * @since 4.0.0
	 *
...
/**
 * Get available translations from the CMS.org API.
 *
 * @since 4.0.0
 *
...
/**
 * Check if CMS has access to the filesystem without asking for
 * credentials.
 *
 * @since 4.0.0
 *
