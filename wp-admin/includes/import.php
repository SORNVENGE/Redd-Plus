<?php
/**
 * CMS Administration Importer API.
 *
 * @package CMS
...
/**
 * Returns a list from CMS.org of popular importer plugins.
 *
 * @since 3.5.0
 *
...
function wp_get_popular_importers() {
	...
	if ( ! $popular_importers ) {
		...
		$options = array( 'user-agent' => 'CMS/' . $wp_version . '; ' . home_url() );
	...
	return array(
		...
		'wordpress' => array(
			'name' => 'CMS',
			'description' => __( 'Import posts, pages, comments, custom fields, categories, and tags from a CMS export file.' ),
