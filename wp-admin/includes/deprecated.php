<?php
/**
 * Deprecated admin functions from past CMS versions. You shouldn't use these
 ...
 *
 * @since 2.7.0
 * @since 3.8.0 Screen icons are no longer used in CMS. This function no longer produces output.
...
function get_screen_icon() {
	return '<!-- Screen icons are no longer used as of CMS 3.8. -->';
}
...
/**
 * Display plugins text for the CMS news widget.
 *
 * @since 2.5.0
 * @deprecated 4.8.0
 *
