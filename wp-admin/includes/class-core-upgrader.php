 ...
 *
 * It allows for CMS to upgrade itself in combination with
...
class Core_Upgrader extends WP_Upgrader {
	...
	public function upgrade_strings() {
		$this->strings['up_to_date'] = __('CMS is at the latest version.');
		...
		$this->strings['rollback_was_required'] = __( 'Due to an error during updating, CMS has rolled back to your previous version.' );
	}
	 ...
	 *
	 * @param object $current Response object for whether CMS is current.
	 * @param array  $args {
	 *        Optional. Arguments for upgrading CMS core. Default empty array.
	 *
	...
	/**
	 * Determines if this CMS Core version should update to an offered version or not.
	 *
	 * @since 3.7.0
	 * @access public
	 *
