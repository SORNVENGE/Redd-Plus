...
class WP_Importer {
	...
	/**
	 * Returns array with imported permalinks from CMS database
	 *
	...
	/**
	 * Return count of imported permalinks from CMS database
	 *
	 * @global wpdb $wpdb CMS database abstraction object.
	 *
	 * @param string $importer_name
	...
	/**
	 * Set array with imported comments from CMS database
	 *
	 * @global wpdb $wpdb CMS database abstraction object.
	 *
	 * @param string $bid
