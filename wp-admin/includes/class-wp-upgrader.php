...
class WP_Upgrader {
	...
	public function generic_strings() {
		...
		$this->strings['fs_no_root_dir'] = __('Unable to locate CMS root directory.');
		$this->strings['fs_no_content_dir'] = __('Unable to locate CMS content directory (wp-content).');
		$this->strings['fs_no_plugins_dir'] = __('Unable to locate CMS plugin directory.');
		$this->strings['fs_no_themes_dir'] = __('Unable to locate CMS theme directory.');
	...
	/**
 	 * Creates a lock using CMS options.
 	 *
 	 * @since 4.5.0
 	 * @access public
 	 * @static
