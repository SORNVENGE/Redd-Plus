<?php
/**
 * Deprecated functions from CMS MU and the multisite feature. You shouldn't
 ...
 * Dashboard blog functionality was removed in CMS 3.1, replaced by the user admin.
 *
 * @since MU
