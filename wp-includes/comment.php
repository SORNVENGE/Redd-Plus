...
/**
 * Retrieve all of the CMS supported comment statuses.
 *
 ...
 * and whether comment is approved by CMS. Also has {@see 'preprocess_comment'}
...
function pingback( $content, $post_id ) {
	...
	foreach ( (array) $post_links as $pagelinkedto ) {
		...
		if ( $pingback_server_url ) {
			 ...
			 * @since 2.9.0
			 *
			 * @param string $concat_useragent    The user agent concatenated with ' -- CMS/'
			 *                                    and the CMS version.
			 ...
			 */
			$client->useragent = apply_filters( 'pingback_useragent', $client->useragent . ' -- CMS/' . get_bloginfo( 'version' ), $client->useragent, $pingback_server_url, $pagelinkedto, $pagelinkedfrom );
...
function weblog_ping($server = '', $path = '') {
	...
	$client->timeout = 3;
	$client->useragent .= ' -- CMS/' . get_bloginfo( 'version' );
