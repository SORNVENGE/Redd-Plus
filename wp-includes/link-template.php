 ...
 *
 * This can be used in the CMS Loop or outside of it.
 *
 * @since 2.0.0
 *
 * @global WP_Rewrite $wp_rewrite
 ...
 *
 * Can be used within the CMS loop or outside of it. Can be used with
 ...
 *
 * Can be used within the CMS loop or outside of it, with any post type.
 *
 * @since 2.9.0
 *
 * @param int    $id           Optional. Post ID. Default is the ID of the global `$post`.
 ...
 * @since 4.1.0
 *
 * @global WP_Query $wp_query CMS Query object.
 *
 * @param array $args {
...
/**
 * Retrieves the URL for the current site where CMS application files
...
/**
 * Retrieves the URL for a given site where CMS application files
 * (e.g. wp-blog-header.php or the wp-admin/ folder) are accessible.
 *
 * Returns the 'site_url' option with the appropriate protocol, 'https' if
