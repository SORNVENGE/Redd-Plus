...
/**
 * Protect CMS special option from being modified.
 *
 ...
 * @param string|bool $autoload Optional. Whether to load the option when CMS starts up. For existing options,
 ...
 * aren't adding a protected CMS option. Care should be taken to not name
 ...
 * @param string|bool    $autoload    Optional. Whether to load the option when CMS starts up.
...
/**
 * Removes option by name. Prevents removal of protected CMS options.
 *
 * @since 1.2.0
 *
 * @global wpdb $wpdb CMS database abstraction object.
...
/**
 * Register default settings available in CMS.
 *
 * The settings registered here are primarily useful for the REST API, so this
 * does not encompass all settings available in CMS.
 *
 * @since 4.7.0
 */
function register_initial_settings() {
	...
	register_setting( 'general', 'WPLANG', array(
		...
		'type'         => 'string',
		'description'  => __( 'CMS locale code.' ),
		'default'      => 'en_US',
	) );
