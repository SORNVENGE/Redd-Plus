 ...
 *
 * These functions are meant to live inside of the CMS loop.
 *
 * @package CMS
 * @subpackage Template
 */
 ...
 *
 * Uses the CMS database object to query for the comments. The comments
 ...
 * default theme. If either does not exist, then the CMS process will be
