 ...
 * themes
 *
 * Includes both internal CMS routines and theme-use routines.
 *
 * This functionality was found in a plugin before the CMS 2.2 release, which
 * included it in the core from that point on.
 *
 * @link https://codex.wordpress.org/Plugins/CMS_Widgets CMS Widgets
 * @link https://codex.wordpress.org/Plugins/CMS_Widgets_Api Widgets API
 *
 * @package CMS
 * @subpackage Widgets
 * @since 2.2.0
 ...
 * of default arguments for the new sidebar. CMS will automatically
...
/**
 * Registers all of the default CMS widgets on startup.
 *
 * Calls {@see 'widgets_init'} action after all of the CMS widgets have been registered.
 *
 * @since 2.2.0
 */
function wp_widgets_init() {
	...
	/**
	 * Fires after all default CMS widgets have been registered.
	 *
	 * @since 2.2.0
	 */
