...
class WP_Http {
	 ...
	 *                                             Default CMS/' . get_bloginfo( 'version' ) . '; ' . get_bloginfo( 'url' ).
	...
	public function request( $url, $args = array() ) {
		$defaults = array(
			 ...
			 * @since 2.7.0
			 *
			 * @param string $user_agent CMS user agent string.
			 */
			'user-agent' => apply_filters( 'http_headers_useragent', 'CMS/' . get_bloginfo( 'version' ) . '; ' . get_bloginfo( 'url' ) ),
			/**
