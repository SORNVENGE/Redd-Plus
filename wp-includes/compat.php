<?php
/**
 * CMS implementation for PHP functions either missing from older PHP versions or not included by default.
 *
 * @package PHP
 * @access private
 */
...
if ( ! function_exists( 'array_replace_recursive' ) ) :
	 ...
	 *
	 * The array_replace_recursive() function is a PHP 5.3 function. CMS
	 ...
	 *
	 * Subject to removal once CMS makes PHP 5.3.0 the minimum requirement.
	 *
	 * @since 4.5.3
	 *
