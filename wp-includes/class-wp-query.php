...
class WP_Query {
	 ...
	 *
	 * The query flags are what page info CMS was able to figure out.
	 *
	 * @since 2.0.0
	 * @access private
	 */
	...
	public function get_posts() {
		 ...
		 *
		 * Return a non-null value to bypass CMS's default post queries.
		 *
	...
	/**
	 * Sets up the CMS query by parsing query string.
	 *
	 * @since 1.5.0
	 * @access public
	 *
	 ...
	 * Constructor.
	 *
	 * Sets up the CMS query, if parameter is not empty.
	 *
	 * @since 1.5.0
	 * @access public
	 *
