<?php
/**
 * Deprecated pluggable functions from past CMS versions. You shouldn't use these
 ...
 * used anywhere in CMS. Also, plugins shouldn't use it either.
 *
 * @since 2.0.3
 * @deprecated 2.5.0
 *
...
/**
 * CMS AtomPub API implementation.
 *
