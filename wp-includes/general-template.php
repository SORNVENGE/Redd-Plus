 ...
 * form into the sidebar and also by the search widget in CMS.
 *
...
/**
 * Provides a simple login form for use anywhere within CMS.
 *
 ...
 * - 'wpurl' - The CMS address (URL) (set in Settings > General)
 * - 'url' - The Site address (URL) (set in Settings > General)
 * - 'admin_email' - Admin email (set in Settings > General)
 * - 'charset' - The "Encoding for pages and feeds"  (set in Settings > Reading)
 * - 'version' - The current CMS version
...
/**
 * Retrieves the contents of the search CMS query variable.
 *
...
/**
 * Displays the URL of a CMS admin CSS file.
 *
...
function wp_admin_css_uri( $file = 'wp-admin' ) {
	...
	/**
	 * Filters the URI of a CMS admin CSS file.
	 *
	 * @since 2.3.0
	 *
 ...
 * (second) parameter.
 *
 * For backward compatibility with CMS 2.3 calling method: If the $file
...
function get_the_generator( $type = '' ) {
	...
	switch ( $type ) {
		case 'html':
			$gen = '<meta name="generator" content="CMS ' . get_bloginfo( 'version' ) . '">';
			break;
		case 'xhtml':
			$gen = '<meta name="generator" content="CMS ' . get_bloginfo( 'version' ) . '" />';
			break;
		case 'atom':
			$gen = '<generator uri="https://wordpress.org/" version="' . get_bloginfo_rss( 'version' ) . '">CMS</generator>';
			break;
		case 'rss2':
		...
		case 'rdf':
			...
			break;
		case 'comment':
			$gen = '<!-- generator="CMS/' . get_bloginfo( 'version' ) . '" -->';
			break;
		case 'export':
			$gen = '<!-- generator="CMS/' . get_bloginfo_rss('version') . '" created="'. date('Y-m-d H:i') . '" -->';
			break;
	}
