 ...
 *
 * The CMS Rewrite class writes the rewrite module rules to the .htaccess
 * file. It also handles parsing the request to get the correct setup for the
 * CMS Query class.
 *
 * The Rewrite along with WP class function as a front controller for CMS.
...
class WP_Rewrite {
	...
	/**
	 * Rules that don't redirect to CMS' index.php.
	 *
	...
	/**
	 * Whether to write every mod_rewrite rule for CMS into the .htaccess file.
	 *
	 ...
	 * set to true. Prior to CMS 3.3 this flag indicated that every page
	...
	<system.webServer>
		...
		$rules .= '
			<rule name="CMS: ' . esc_attr( home_url() ) . '" patternSyntax="Wildcard">
				<match url="*" />
					<conditions>
