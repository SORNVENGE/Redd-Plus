 ...
 * CMS Query API
 *
 * The query API attempts to get which part of CMS the user is on. It
 ...
 *
 * This must not be used within the CMS Loop.
 *
 * @since 1.5.0
 *
 * @global WP_Query $wp_query Global WP_Query instance.
...
/**
 * Whether current CMS query has results to loop over.
 *
 * @since 1.5.0
 *
 * @global WP_Query $wp_query Global WP_Query instance.
