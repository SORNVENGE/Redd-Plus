<?php
/**
 * XML-RPC protocol support for CMS
 *
 * @package CMS
...
/**
 * CMS XMLRPC server implementation.
 *
 * Implements compatibility for Blogger API, MetaWeblog API, MovableType, and
 * pingback. Additional CMS API for managing comments, pages, posts,
 * options, etc.
 *
 * As of CMS 3.5.0, XML-RPC is enabled by default. It can be disabled
...
class wp_xmlrpc_server extends IXR_Server {
	...
	/**
	 * Convert a CMS date string to an IXR_Date object.
	 *
	 * @access protected
	 *
	...
	/**
	 * Convert a CMS GMT date string to an IXR_Date object.
	 *
	 * @access protected
	 *
	 * @param string $date_gmt CMS GMT date string.
	...
	public function mw_newPost($args) {
		...
		// Let CMS generate the post_name (slug) unless
	...
	public function mw_editPost( $args ) {
		...
		// Let CMS manage slug if none was provided.
	...
	public function pingback_ping( $args ) {
		...
		$user_agent = apply_filters( 'http_headers_useragent', 'CMS/' . get_bloginfo( 'version' ) . '; ' . get_bloginfo( 'url' ) );
