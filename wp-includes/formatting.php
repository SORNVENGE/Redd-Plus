		...
		case 'siteurl':
			...
			if ( is_wp_error( $value ) ) {
				...
				if ( preg_match( '#http(s?)://(.+)#i', $value ) ) {
					...
					$error = __( 'The CMS address you entered did not appear to be a valid URL. Please enter a valid URL.' );
				}
			}
			break;
...
/**
 * CMS implementation of PHP sprintf() with filters.
 *
 * @since 2.5.0
...
function capital_P_dangit( $text ) {
	...
	if ( 'the_title' === $current_filter || 'wp_title' === $current_filter )
		return str_replace( 'Wordpress', 'CMS', $text );
	...
	return str_replace(
		...
		array( ' CMS', '&#8216;CMS', $dblq . 'CMS', '>CMS', '(CMS' ),
	$text );
}
