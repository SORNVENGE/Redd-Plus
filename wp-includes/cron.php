 ...
 *
 * Schedules an event which will execute once by the CMS actions core at
 * a time which you specify. The action will fire off when someone visits your
 * CMS site, if the schedule time has passed.
 *
 ...
 *
 * Schedules a hook which will be executed by the CMS actions core on a
 * specific interval, specified by you. The action will trigger when someone
 * visits your CMS site, if the scheduled time has passed.
 *
