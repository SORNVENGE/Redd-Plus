...
/**
 * Bridge to connect Requests internal hooks to CMS actions.
 *
 * @package CMS
 * @subpackage HTTP
 * @since 4.7.0
...
class WP_HTTP_Requests_Hooks extends Requests_Hooks {
	...
	/**
	 * Dispatch a Requests hook to a native CMS action.
	 *
	...
	public function dispatch( $hook, $parameters = array() ) {
		...
		/**
		 * Transforms a native Request hook to a CMS actions.
		 *
		 * This action maps Requests internal hook to a native CMS action.
		 *
