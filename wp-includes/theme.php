 ...
 * CMS workflow, then change the former. If you just have the locale in a
...
function get_theme_root_uri( $stylesheet_or_template = false, $theme_root = false ) {
	 ...
	 * @param string $siteurl                CMS web address which is set in General Options.
 ...
 * CMS is loading, especially in the Customizer preview
