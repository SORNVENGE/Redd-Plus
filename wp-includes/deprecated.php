<?php
/**
 * Deprecated functions from past CMS versions. You shouldn't use these
...
function start_wp() {
	...
	_deprecated_function( __FUNCTION__, '1.5.0', __('new CMS Loop') );
 ...
 * support. This is not the fault of CMS (where functionality is
 ...
 *
 * Determines if the URL can be accessed over SSL by using the CMS HTTP API to access
