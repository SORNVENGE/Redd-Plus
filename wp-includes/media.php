 ...
 * parameters are: what CMS will use for the class, the Attachment ID,
...
function wp_calculate_image_srcset( $size_array, $image_src, $image_meta, $attachment_id = 0 ) {
	...
	/*
	 * CMS flattens animated GIFs into one frame when generating intermediate sizes.
	...
	/*
	 * Images that have been edited in CMS after being uploaded will
 ...
 * a collection of CMS audio or video files in a post.
 *
 * @since 3.9.0
 *
 * @global int $content_width
