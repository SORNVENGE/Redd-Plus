...
* This template can be overridden by copying it to ' yourtheme/ul-templates/12-sync-slider/0.php '.
*
						...
						<div class="ultimate-layouts-entry-wrapper entry-content">
							<div class="ultimate-layouts-picture">              
								<div class="ultimate-layouts-picture-wrap ultimate-layouts-get-pic">
									...
									'.$post_taxonomy_absolute.$post_title_white_f24.$post_metas_1_silver.$ul_geodir_get_rating_stars.'
									</div>                 
								</div>                                                   
							</div>
						</div>        
...
$sync_slider_sc.=	'<article class="ultimate-layouts-item hentry">
						<div class="ultimate-layouts-entry-wrapper entry-content">							
							<div class="ultimate-layouts-picture">              
								<div class="ultimate-layouts-picture-wrap ultimate-layouts-get-pic">
									'.$post_image_small_cb.$post_overlay.'
								</div>                            
							</div>
