...
* This template can be overridden by copying it to ' yourtheme/ul-templates/12-sync-slider/2.php '.
*
						...
						<div class="ultimate-layouts-entry-wrapper entry-content">
							<div class="ultimate-layouts-picture">              
								<div class="ultimate-layouts-picture-wrap ultimate-layouts-get-pic">
									...
									'.$post_taxonomy.$post_title_white_f48.$post_metas_1_silver.$ul_geodir_get_rating_stars.$post_metas_2.'
									</div>                 
								</div>                                                   
							</div>
						</div>        
