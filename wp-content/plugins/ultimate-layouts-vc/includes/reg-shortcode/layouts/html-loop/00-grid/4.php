...
* This template can be overridden by copying it to ' yourtheme/ul-templates/00-grid/4.php '.
*
...
<article class="ultimate-layouts-item hentry">
    ...
    <div class="ultimate-layouts-entry-wrapper entry-content">    
        ...
        <div class="ultimate-layouts-content entry">            
            <?php echo $post_taxonomy_absolute_white;?>            
            <?php echo $post_title_bg;?>            
            <?php echo $post_metas_1;?>  
            <?php echo $ul_geodir_get_rating_stars;?>           
            <?php echo $post_excerpt;?>   
            <?php echo $wooBasicElmBlock;?>         
            <?php echo $post_metas_2_style_1;?>            
        </div><!--content-->
    </div><!--entry content-->            
</article><!--post item-->