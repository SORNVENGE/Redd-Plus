...
* This template can be overridden by copying it to ' yourtheme/ul-templates/04-list/4.php '.
*
...
<article class="ultimate-layouts-item hentry">
    ...
    <div class="ultimate-layouts-entry-wrapper entry-content">    
        ...
        <?php }?>
        <!--picture-->
        <?php if($post_image=='' || $s_image==false || $post_excerpt!='' || $post_metas_2!='' || $wooBasicElmBlock!='' || $ul_geodir_get_rating_stars!=''){?>          
            <!--content-->
